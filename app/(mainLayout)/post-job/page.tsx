...
const PostJobPage = async () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-5 mb-5">
      <CreateJobForm companyAbout={data.about} companyName={data.name} companyLocation={data.location} companyWebsite={data.website} companyLogo={data.logo} companyXAccount={data.xAccount} />
